...
public class Instrumented4TestStepExecutorFactory implements StepExecutorFactory {

    @Override
    public String getSupportedStep() {
        return Instrumented4TestStepDefinition.TYPE;
    }
    ...
    public StepExecutor createStepExecutor(Step step, Map<String, Handler> handlers) {
        return new Instrumented4TestStepExecutor();
    }
}
