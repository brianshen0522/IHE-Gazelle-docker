...
> **_NOTE:_**  You need to create a .env file to load required environment variables. You can find them
> [here](../../docs/installation-manual/installation-guide.md#4-environment-variables).
...
You can then execute your native executable with: `./target/user-management-quarkus-<version>-runner`
