...
public interface UserController {
    ...
    @Operation(summary = "Register a new user", description = "Register a new user. This endpoint is public to allows" +
            ...
            " during the registration or join an existing one.")
    ...
    @APIResponse(responseCode = "409", description = "Conflict - The email already exist",
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    Response registerUser(UserRegisterRequest userRegisterRequest);
    ...
    @Operation(summary = "Create a new user", description = "Create a new user. The new user is activated by default and" +
            " can join an existing organization or create a new organization")
    @RequestBody(content = @Content(mediaType = MediaType.APPLICATION_JSON, examples = {
    ...
    @ProtectedResource
    @SecurityRequirement(name = ApplicationConfig.SECURITY_SCHEME)
    @Operation(summary = "Update the user attributes", description = "Update the user attributes.")
    ...
    @APIResponse(responseCode = "409", description = "Conflict - The email already exist",
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    Response patch(@PathParam("userId") String userId, UserEditionResource userResource);
    ...
    Response searchAndFilterSummary(
    ...
    @ProtectedResource
    @SecurityRequirement(name = ApplicationConfig.SECURITY_SCHEME)
    @Operation(summary = "Retrieve an user by its id", description = "Retrieve an user by its id.")
    ...
    @APIResponse(responseCode = "404", description = NOT_FOUND_DESCRIPTION,
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    Response getUserSummaryById(@PathParam("userId") String userId);
    ...
    @APIResponse(responseCode = "404", description = "Not found - No user corresponding to the activation code",
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    Response activateFromActivationCode(@PathParam("activationCode") String activationCode);
    ...
    @ProtectedResource
    @SecurityRequirement(name = ApplicationConfig.SECURITY_SCHEME)
    @Operation(summary = "Activate a user from its id", description = "Activate a user from its id.")
    ...
    @APIResponse(responseCode = "404", description = NOT_FOUND_DESCRIPTION,
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    Response activate(ActivationResource activationResource);
    ...
    @ProtectedResource
    @SecurityRequirement(name = ApplicationConfig.SECURITY_SCHEME)
    @Operation(summary = "Deactivate a user from its id", description = "Deactivate a user from its id.")
    ...
    @APIResponse(responseCode = "404", description = NOT_FOUND_DESCRIPTION,
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    Response deactivate(ActivationResource activationResource);
    ...
    @Operation(summary = "Delete the user associated to the given id",
            description = "Delete the user associated to the given id.")
    ...
    @Tag(name = "User preferences management", description = "User preferences API.")
    @SecurityRequirement(name = ApplicationConfig.SECURITY_SCHEME)
    @ProtectedResource
    @Operation(summary = "Get user preferences by user id",
            description = "Returns all preferences as per the user id")
    ...
    @APIResponse(responseCode = "404", description = NOT_FOUND_DESCRIPTION,
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    @Parameter(name = "userId", description = "User id", example = "9ec7105a-be72-4a37-955d-b5a665d69da4")
    Response getUserPreferences(@PathParam("userId") String userId);
    ...
    @Operation(summary = "Get a single user preferences by user id and the preference name",
            description = "Returns the wanted preference as per the user id")
    @APIResponse(responseCode = "200", description = "OK - Successfully retrieved")
    @APIResponse(responseCode = "401", description = UNAUTHORIZED_DESCRIPTION,
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    @APIResponse(responseCode = "403", description = FORBIDDEN_DESCRIPTION,
    ...
    Response getSingleUserPreference(@PathParam("userId") String userId, @PathParam("preferenceId") String preferenceId);
    ...
    @APIResponse(responseCode = "404", description = "Not found - The user or the preference was not found")
    @Parameter(name = "userId", description = "User id", example = "9ec7105a-be72-4a37-955d-b5a665d69da4")
    @RequestBody(description = "User preference(s) to update", required = true,
            content = @Content(schema = @Schema(implementation = UserPreferenceResource.class)))
    Response updateUserPreference(@PathParam("userId") String userId, UserPreferenceResource userPreferenceResource);
    ...
    @Operation(summary = "Get the profile picture by user id",
            description = "Returns the profile picture as per the user id")
    @APIResponse(responseCode = "200", description = "OK - Successfully retrieved")
    ...
    Response getProfilePicture(@PathParam("userId") String userId, @QueryParam("format") String format);
    ...
    @Operation(summary = "Update the profile picture by user id",
            description = "Update the profile picture as per the user id")
    ...
    @APIResponse(responseCode = "404", description = NOT_FOUND_DESCRIPTION,
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    @Parameter(name = "userId", description = "User id", example = "9ec7105a-be72-4a37-955d-b5a665d69da4")
    Response updateProfilePicture(@PathParam("userId") String userId, byte[] profilePicture);
    ...
    @Operation(summary = "Reset the profile picture by user id to the default one",
            description = "Reset the profile picture as per the user id to the default one")
    ...
    @APIResponse(responseCode = "404", description = NOT_FOUND_DESCRIPTION,
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    @Parameter(name = "userId", description = "User id", example = "9ec7105a-be72-4a37-955d-b5a665d69da4")
    Response deleteUserProfilePicture(@PathParam("userId") String userId);
    ...
    @Operation(summary = "Join the group in the request body",
            description = "Join the group in the request body.")
    ...
    @APIResponse(responseCode = "404", description = "Not found - The user or the group was not found",
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    @Parameter(name = "userId", description = "User id", example = "9ec7105a-be72-4a37-955d-b5a665d69da4")
    Response joinGroup(@PathParam("userId") String userId, GroupIdResource groupIdResource);
    ...
    @Operation(summary = "Leave the group in the request body",
            description = "Leave the group in the request body.")
    ...
    @APIResponse(responseCode = "404", description = "Not found - The user or the group was not found",
            content = @Content(schema = @Schema(implementation = ErrorResponseBody.class), mediaType = MediaType.APPLICATION_JSON))
    @Parameter(name = "userId", description = "User id", example = "9ec7105a-be72-4a37-955d-b5a665d69da4")
    Response leaveGroup(@PathParam("userId") String userId, GroupIdResource groupIdResource);
