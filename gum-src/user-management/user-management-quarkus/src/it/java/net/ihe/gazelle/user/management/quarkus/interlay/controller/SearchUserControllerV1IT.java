...
class SearchUserControllerV1IT {

    public static final String BEARER = "Bearer ";
    private static final String GUM_REST_USERS = "/rest/users";
    private final Logger logger = LoggerFactory.getLogger(SearchUserControllerV1IT.class);
    private static final String FIRSTNAME = "FIRSTNAMEtwoVOne";
    private static final String LASTNAME = "LASTNAMEtwoVOne";
    private static final String USER_EMAIL = "lookup-user-controller@test-v1.fr";
    ...
    void createUserToEditTest() {
        String body = JSONMaker.makeUserCreation(FIRSTNAME, LASTNAME, USER_EMAIL,"KERLookupC-v1", "Kereval3-v1");
    ...
    void searchUsersTest() {
        ...
        given()
                ...
                .get(GUM_REST_USERS + "?search=FIRSTNAMEtwoVOne&offset=0&limit=1")
                .then()
                .statusCode(200)
    ...
    void filterUsersTestVariousCases() {
        ...
        User user1 = new User("id1", "FIRSTNAMEoneVOne", "LASTNAMEoneVOne", "filter-user1@test-v1.fr", orgaID, new HashSet<>());
        User user2 = new User("id2", "FIRSTNAMEtwoVOne", "LASTNAMEtwoVOne", "filter-user2@test-v1.fr", orgaID, new HashSet<>());


        User user3 = new User("id3", "FIRSTNAMEthreeVOne", "LASTNAMEthreeVOne", "filter-user3@test-v1.fr", orgaID, new HashSet<>());
        User user4 = new User("id4", "FIRSTNAMEthreeVOne", "LASTNAMEtwoVOne", "filter-user4@test-v1.fr", orgaID, new HashSet<>());
        ...
        given()
                .when()
                .header(HttpHeaders.AUTHORIZATION, BEARER + jwt)
                .get(GUM_REST_USERS + "?firstName=FIRSTNAMEthreeVOne&limit=6")
                .then()
                .statusCode(200)
                .header(CONTENT_RANGE, containsString("users 0-6/2"))
                .body("users.firstName", hasItems("FIRSTNAMEthreeVOne"))
                .body("users.email", hasItems("filter-user4@test-v1.fr", "filter-user3@test-v1.fr"))
                .body("users.email", not(hasItems("filter-user1@test-v1.fr", "filter-user2@test-v1.fr")))
                .body("count", equalTo(2));

        given()
                .when()
                .header(HttpHeaders.AUTHORIZATION, BEARER + jwt)
                .get(GUM_REST_USERS + "?firstName=FIRSTNAMEthreeVOne&limit=2")
                .then()
                .statusCode(200)
                .header(CONTENT_RANGE, containsString("users 0-2/2"))
                .body("users.firstName", hasItems("FIRSTNAMEthreeVOne"))
                .body("users.email", hasItems("filter-user4@test-v1.fr"))
                .body("users.email", not(hasItems("filter-user2@test-v1.fr")))
                .body("count", equalTo(2));

        given()
                .when()
                .header(HttpHeaders.AUTHORIZATION, BEARER + jwt)
                .get(GUM_REST_USERS + "?firstName=FIRSTNAMEoneVOne&limit=1")
                .then()
                .statusCode(200)
                .header(CONTENT_RANGE, containsString("users 0-1/1"))
                .body("users.firstName", hasItems("FIRSTNAMEoneVOne"))
                .body("users.email", hasItems("filter-user1@test-v1.fr"))
                .body("users.email", not(hasItems("filter-user2@test-v1.fr")))
        ...
        given()
                ...
                .statusCode(200)
                .body("users.firstName", hasItems("FIRSTNAMEoneVOne"))
                .body("users.email", hasItems("filter-user1@test-v1.fr", "filter-user2@test-v1.fr"))
        ...
        given()
                ...
                .statusCode(200)
                .body("users.email", hasItems("filter-user1@test-v1.fr", "filter-user2@test-v1.fr",
                        "filter-user3@test-v1.fr", "filter-user4@test-v1.fr"))
